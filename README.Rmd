...
## Data
Fake data are created and stored in the `data-raw` directory.
...
- Use `drake::code_to_plan()` to bring those R scripts into your drake plan. In this example, those actions are stored in `_drake.R`
- The `exec_drake.R` file is the main control file for the project. The most important element of this script is the `drake::make()` function. This file also sources all other main files.   
